...
public abstract class EnemyMelee implements EnemySkill, Serializable{
	...
	public EnemyMelee(int positionX, int positionY, int width, int height,
			int damage, Player p){
	...
	public void render(SpriteBatch batch) {
		if(active){
			batch.draw(image, p.getPositionX(), p.getPositionY(), p.getWidth(), p.getHeight());
		}
